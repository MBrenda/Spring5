...
public class ClienteController {
	...
	// cargamos la img de forma programatica, a traves de la respuesta de un
	// resource UrlResource
	// .+ es para que no pase la extension
	...
	// recibe el obj cliente que viene del formulario, lo guarda y redirecciona a la
	// vista lista
	...
	public String guardar(@Valid Cliente cliente, BindingResult results, Model model,
		...
		if (!foto.isEmpty()) {
//			Path directorioRecursos = Paths.get("src//main//resources//static/UPLOADS_FOLDER");
//			String rootPath = directorioRecursos.toFile().getAbsolutePath();

//			String rootPath = "C://UPLOADS_FOLDER";
	...
	public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes flash) {
		if (id > 0) {
			...
			flash.addFlashAttribute("success", "Cliente eliminado éxito");
